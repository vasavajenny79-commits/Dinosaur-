...
yesBtn.addEventListener("click", () => {
    ...
    if (!hasTouchedNo) {
        ...
        document.body.style.background = "#e6fffa"; // Light teal success color
    }
});

// Falling Hearts and Love Letters
setInterval(() => {
    const symbols = ["💖", "💕", "✉️", "💌", "❤️"];
